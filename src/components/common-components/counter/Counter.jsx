    ...
    <>
      <RowWrapper>
        <ColumnWrapper autoWidth>
          <CountFrame>{time.d}</CountFrame>
          <Text14>Days</Text14>
        </ColumnWrapper>
        <ColumnWrapper autoWidth>
          <CountFrame>{time.h}</CountFrame>
          <Text14>Hours</Text14>
        </ColumnWrapper>
        <ColumnWrapper autoWidth>
          <CountFrame>{time.m}</CountFrame>
          <Text14>Minutes</Text14>
        </ColumnWrapper>
        <ColumnWrapper autoWidth>
          <CountFrame>{time.s}</CountFrame>
...
Counter.defaultProps = {
  date: new Date('Jul 24, 2020 00:00:00'),
};
